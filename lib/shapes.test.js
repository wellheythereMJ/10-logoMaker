...
describe('Square', () => {
  ...
  test('render', () => {
    ...
    expect(square.rendor()).toBe(`<svg version="1.1" width="300" height="300" xmlns="http://www.w3.org/2000/svg"> <rect width="100%" height="100%" fill="red" /> <text x="150" y="125" font-size="60" text-anchor="middle" fill="white">hello</text> </svg>`)
  })
});
...
describe('Triangle', () => {
  ...
  test('render', () => {
    ...
    expect(triangle.rendor()).toBe(`<svg version="1.1" width="300" height="300" xmlns="http://www.w3.org/2000/svg"> <polygon fill="red" points="100,20 200,170 0,170" /> <text x="50" y="140" font-size="50" text-anchor="middle" fill="white">hello</text> </svg>`);
  })
});
...
describe('Circle', () => {
  ...
  test('render', () => {
    ...
    expect(circle.rendor()).toBe(`<svg version="1.1" width="300" height="300" xmlns="http://www.w3.org/2000/svg"> <circle cx="150" cy="150" r="150" fill="red" /> <text x="150" y="125" font-size="60" text-anchor="middle" fill="white">hello</text> </svg>`);
  })
});