...
describe('Square', () => {
  ...
  test('render', () => {
    ...
    expect(square.rendor()).toBe(`<svg version="1.1" width="300" height="300" xmlns="http://www.w3.org/2000/svg"> <rect width="100%" height="100%" fill="red" /> <text x="150" y="150" font-size="60" text-anchor="middle" fill="white">hello</text> </svg>`)
  })
});
